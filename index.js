...
// Load independent AI styles
const independentAIStyle = document.createElement('link');
independentAIStyle.rel = 'stylesheet';
independentAIStyle.type = 'text/css';
independentAIStyle.href = './scripts/extensions/third-party/mobile/independent-ai.css';
independentAIStyle.onload = () => {
  console.log('[Mobile Context] Independent AI styles loaded');
};
independentAIStyle.onerror = () => {
  console.error('[Mobile Context] Independent AI styles failed to load');
};
document.head.appendChild(independentAIStyle);
