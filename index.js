...
// [已迁移到 phone-loader.js] 加载微博功能模块 (weibo-manager / weibo-auto-listener)
// [已迁移到 phone-loader.js] 加载论坛功能模块 (forum-manager / forum-styles / forum-auto-listener)
...
// [重复加载修复] phone-loader.js 已由 mobile-phone.js 底部 IIFE 加载（第7630行），
// 此处注释掉以避免双重加载导致模块重复注册和事件监听器泄漏。
...
// [已迁移到 phone-loader.js] 加载语音消息处理器 (voice-message-handler)

// [暂时跳过] 微信语音增强器 — MIME 类型问题待修复
