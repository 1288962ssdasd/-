...
(function () {
  ...
  if (window.QuestPlannerBridge) {
    if (!window.QuestPlannerBridge.isReady && typeof window.QuestPlannerBridge.isAvailable === 'function') {
      window.QuestPlannerBridge.isReady = function() {
        return window.QuestPlannerBridge.isAvailable();
      };
    }
    log('log', 'ST适配别名已添加: isReady');
  }
