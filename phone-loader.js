...
(function () {
  ...
  var MODULES = [
    ...
    { name: 'phone-core',         src: 'phone-core.js',               globalVar: '__PHONE_CORE__',     deps: ['phone-data-store'] },
    ...
    // ---- 论坛模块 ----
    { name: 'forum-styles',       src: 'app/forum-app/forum-styles.js',       globalVar: 'forumStyles',       deps: [] },
    { name: 'forum-manager',      src: 'app/forum-app/forum-manager.js',      globalVar: 'forumManager',      deps: ['bridge-api'] },
    { name: 'forum-auto-listener',src: 'app/forum-app/forum-auto-listener.js',globalVar: 'forumAutoListener', deps: ['forum-manager'] },
    { name: 'forum-ui',           src: 'app/forum-app/forum-ui.js',           globalVar: 'forumUI',           deps: ['forum-manager', 'forum-styles'] },
    { name: 'forum-control-app',  src: 'app/forum-app/forum-control-app.js',  globalVar: 'forumControlApp',  deps: ['forum-ui'] },
    // ---- 微博模块 ----
    { name: 'weibo-styles',       src: 'app/weibo-app/weibo-styles.js',       globalVar: 'weiboStyles',       deps: [] },
    { name: 'weibo-manager',      src: 'app/weibo-app/weibo-manager.js',      globalVar: 'weiboManager',      deps: ['bridge-api'] },
    { name: 'weibo-auto-listener',src: 'app/weibo-app/weibo-auto-listener.js',globalVar: 'weiboAutoListener', deps: ['weibo-manager'] },
    { name: 'weibo-ui',           src: 'app/weibo-app/weibo-ui.js',           globalVar: 'weiboUI',           deps: ['weibo-manager', 'weibo-styles'] },
    { name: 'weibo-control-app',  src: 'app/weibo-app/weibo-control-app.js',  globalVar: 'weiboControlApp',  deps: ['weibo-ui'] }
  ];
  ...
  var CSS_FILES = [
    ...
    'app/message-app.css',
    'quest-app.css',
    'app/forum-app/forum-ui.css',
    'app/forum-app/forum-control-app.css',
    'app/weibo-app/weibo-ui.css',
    'app/weibo-app/weibo-control-app.css'
  ];
